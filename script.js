...
function handleFile(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            displayCards(decks.extraDeck, 'extraDeck');
            displayCards(decks.sideDeck, 'sideDeck');
        };
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('testHandButton').addEventListener('click', generateTestHand);
    document.getElementById('test100HandsButton').addEventListener('click', test100Hands);
    document.getElementById('saveValuesButton').addEventListener('click', saveValuesToCookie);
